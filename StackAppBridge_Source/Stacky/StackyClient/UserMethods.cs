...
namespace Stacky
{
    ...
    {
      public virtual IPagedList<InboxItem> GetInboxItems(int? page = null, int? pageSize = null, string site_ = "stackoverflow", string _filter = null, string accessToken = null)
        {
          var response = MakeRequest<InboxItemResponse>("me/inbox", null, new
          {
            key = apiKey,
            page = page ?? null,
          ...
          return new PagedList<InboxItem>(response.InboxItems, response);
        }

        public virtual IPagedList<Notification> GetNotifications(int? page = null, int? pageSize = null, string _filter = null, string accessToken = null)
        {
          var response = MakeRequest<NotificationResponse>("notifications", null, new
          {
            key = apiKey,
            page = page ?? null,
            pagesize = pageSize ?? null,
          ...
          return new PagedList<Notification>(response.Notifications, response);
        }
