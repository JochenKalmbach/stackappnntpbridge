...
namespace Stacky
{
    ...
    public partial class StackyClient
    {
        ...
        //{
        //    return GetAnswers(answerId.ToArray()).FirstOrDefault();
        //}

        public virtual IPagedList<Answer> GetAnswers(IEnumerable<int> answerIds, string site_ = "stackoverflow", string filter_ = null, string accessToken = null)
        {
            var response = MakeRequest<AnswerResponse>("answers", new [] { answerIds.Vectorize() }, new
            {
                key = apiKey,
                site = site_,
                filter = filter_,
        ...
        ///// <returns></returns>
        //public virtual IPagedList<Answer> GetAnswers(AnswerSort sortBy = AnswerSort.Activity, SortDirection sortDirection = SortDirection.Descending, int? page = null, int? pageSize = null, bool includeBody = false, bool includeComments = false, bool includeAnswers = false, int? min = null, int? max = null, DateTime? fromDate = null, DateTime? toDate = null, string site_ = "stackoverflow", string accessToken = null)
        //{
