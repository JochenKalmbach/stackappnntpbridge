...
namespace Stacky
{
    ...
    public partial class StackyClient
    {
        ...
        public virtual IPagedList<Answer> GetAnswers(IEnumerable<int> answerIds, string site_ = "stackoverflow", string filter_ = null)
        {
        ...
        /// <returns></returns>
        public virtual IPagedList<Answer> GetAnswers(AnswerSort sortBy = AnswerSort.Activity, SortDirection sortDirection = SortDirection.Descending, int? page = null, int? pageSize = null, bool includeBody = false, bool includeComments = false, bool includeAnswers = false, int? min = null, int? max = null, DateTime? fromDate = null, DateTime? toDate = null, string site_ = "stackoverflow")
        {
